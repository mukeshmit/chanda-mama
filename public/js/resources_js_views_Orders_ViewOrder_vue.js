    ...
    downloadInvoice: function downloadInvoice() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(response) {
          var contentType, message, errorPayload, fileURL, fileLink, _t, _t2;
          return _regenerator().w(function (_context) {
            while (1) switch (_context.p = _context.n) {
              case 0:
                ...
                message = 'Unable to generate order invoice.';
                _context.p = 1;
                _t = JSON;
                _context.n = 2;
                return response.data.text();
              case 2:
                errorPayload = _t.parse.call(_t, _context.v);
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm.invoiceRoute ? _c("router-link", {
    ...
    staticClass: "btn btn-outline-dark rounded-3 px-4 py-2 d-flex align-items-center gap-2",
    staticStyle: {
      "font-weight": "500"
    },
    on: {
