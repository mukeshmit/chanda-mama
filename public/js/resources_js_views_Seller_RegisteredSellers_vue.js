...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.__("seller_requests")))]), _vm._v(" "), _c("nav", {
    attrs: {
  ...
  }), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.__("refresh") || "Refresh"))])])])]), _vm._v(" "), _c("b-row", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(row) {
        return [_c("small", {
          ...
          staticClass: "table table-borderless"
        }, [_c("tr", [_c("th", [_vm._v(" " + _vm._s(_vm.__("name")))]), _vm._v(" "), _c("td", [_vm._v(" : " + _vm._s(row.item.store_name))])]), _vm._v(" "), _c("tr", [_c("th", [_vm._v(" " + _vm._s(_vm.__("url")))]), _vm._v(" "), _c("td", [_vm._v(" : " + _vm._s(row.item.store_url))])]), _vm._v(" "), _c("tr", [_c("th", [_vm._v(" " + _vm._s(_vm.__("description")))]), _vm._v(" "), _c("td", [_vm._v(" : " + _vm._s(_vm.strip_tags(row.item.store_description)))])])])]), _vm._v("\n                                " + _vm._s(row.item.store_name) + "\n                            ")];
      }
    }, {
      key: "cell(other_info)",
      fn: function fn(row) {
        return [_c("small", {
          ...
          staticClass: "badge bg-success d-flex align-items-center gap-1",
          attrs: {
            target: "_blank",
        ...
        }), _vm._v("\n                                            " + _vm._s(_vm.__("national_identity_card")))], 1)]), _vm._v(" "), _c("p", [_c("a", {
          staticClass: "badge bg-success d-flex align-items-center gap-1",
          attrs: {
            target: "_blank",
        ...
        }), _vm._v(" " + _vm._s(_vm.__("address_proof")) + " ")], 1)])]), _vm._v("\n                                " + _vm._s(row.item.store_name) + "\n                            ")];
      }
    }, {
      key: "cell(logo)",
      fn: function fn(row) {
      ...
      fn: function fn(row) {
        ...
        }, [_vm._v(_vm._s(_vm.__("reject")))]) : row.item.status == 3 ? _c("label", {
      ...
      fn: function fn(row) {
        return [row.item.require_products_approval == 1 ? _c("label", {
          staticClass: "badge bg-success"
        }, [_vm._v(_vm._s(_vm.__("yes")))]) : row.item.require_products_approval == 0 ? _c("label", {
          staticClass: "badge bg-danger"
      ...
      fn: function fn(row) {
        return [_c("div", {
          staticClass: "d-flex gap-2"
        }, [_vm.$can("seller_delete") ? _c("button", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
        ...
        })], 1) : _vm._e(), _vm._v(" "), _vm.$can("seller_delete") ? _c("button", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
