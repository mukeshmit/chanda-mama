...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$appName))])])]), _vm._v(" "), _c("h4", [_vm._v(_vm._s(_vm.__("reset_your_password_here")))]), _vm._v(" "), _c("form", {
    on: {
    ...
    domProps: {
      checked: Array.isArray(_vm.user.password_confirmation) ? _vm._i(_vm.user.password_confirmation, null) > -1 : _vm.user.password_confirmation
    },
    on: {
      change: function change($event) {
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.user, "password_confirmation", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.user, "password_confirmation", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
    ...
    domProps: {
      checked: _vm._q(_vm.user.password_confirmation, null)
    },
    on: {
      change: function change($event) {
        return _vm.$set(_vm.user, "password_confirmation", null);
      }
    }
  }) : _c("input", {
    directives: [{
    ...
    attrs: {
      src: _vm.showPasswordConfirmation ? _vm.$baseUrl + "/images/icons/show_password.svg" : _vm.$baseUrl + "/images/icons/hide_password.svg",
      alt: "toggle-password"
    }
  })])]), _vm._v(" "), _c("button", {
  ...
  }, [_vm._v(" @ " + _vm._s(new Date().getFullYear()) + " " + _vm._s(_vm.$appName) + ". All Right Reserved")])])])])])]);
};
