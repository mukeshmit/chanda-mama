        ...
        <form v-else ref="my-form" @submit.prevent="saveRecord" novalidate>
            ...
            <b-tabs v-model="activeLanguageTab" content-class="mt-3" v-if="languages.length > 0">
                <b-tab v-for="language in languages" :key="language.id" :title="language.name" lazy>
                    ...
                    <div class="row">
                        <!-- Parent category and subcategory (only show in default language tab) -->
...
export default {
    ...
    watch: {
        parent_category_id() {
            const hasSelectedSubcategory = this.filteredParentSubcategories.some(subcategory => {
                return Number(subcategory.id) === Number(this.parent_id);
            });
    ...
    methods: {
            ...
            return axios.get(this.$apiUrl + '/categories', {
                ...
                .then(response => {
                    if (response.data.data) {
                        ...
                        this.setParentCategoryFromSubcategory();
        ...
        setParentCategoryFromSubcategory() {
        ...
        saveRecord: async function () {
            ...
            saveSequentially()
                .then(() => {
                    ...
                    vm.hideModal();
                    vm.$router.push({ path: '/manage_sub_subcategories' });
                })
                .catch(error => {
                    vm.isLoading = false;
