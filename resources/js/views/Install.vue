                    ...
                    <form-wizard @on-complete="onComplete"
                        ...
                        <tab-content title="Welcome">
                            <div class="text-center">
                                ...
                                <p>Thank you for choosing the eGrogcer script from Koober.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="password" placeholder="Database Password" v-model="database.database_password" id="database_password" class="form-control" autocomplete="off" />
                                            </div>
                                        </div>
