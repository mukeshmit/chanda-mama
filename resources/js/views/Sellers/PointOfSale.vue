        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Products Grid -->
                        <div class="row g-4">
                            <div v-for="(product, index) in products" :key="product.id" class="col-6 col-sm-4 col-md-4 col-lg-3">
                        ...
                        <div class="figma-table-footer flex-wrap gap-3 mt-4">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="showing-results-text small text-nowrap">
                                    {{ __('Showing Result') }} : <span class="showing-bold">{{ paginationInfo.to }}</span> {{ __('of') }} <span class="showing-bold">{{ paginationInfo.total }}</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                <b-pagination 
                                    v-model="currentPage" 
                                    :total-rows="paginationInfo.total" 
                                    :per-page="perPage" 
                                    align="right" 
            ...
            <div class="col-lg-4 col-12">
                <div class="row g-3 mb-4 mt-1">
                    <div class="col-6">
                        <button class="btn btn-primary w-100 py-2 figma-btn-standard" @click="showDiscountModal" :disabled="cart.length === 0">
                            <i class="fas fa-percentage me-1"></i>{{ __('add_discount') }}
                        </button>
                    </div>
                    <div class="col-6">
                        <button class="btn btn-primary w-100 py-2 figma-btn-standard" @click="showAdditionalChargeModal" :disabled="cart.length === 0">
                            <i class="fas fa-plus-circle me-1"></i>{{ __('add_additional_charges') }}
                        </button>
                    </div>
                </div>

                <div class="card mb-4 customer-details-card">
                        ...
                        <div class="row g-3 align-items-stretch mt-1">
                            <div class="col-sm-8 col-12">
                                <div class="search-select">
                                    <input type="text" class="form-control py-2 h-100" v-model="customerSearchTerm"
                                        @input="searchCustomers" :placeholder="__('search_customer')" />
                                    <div class="search-results shadow-lg" v-if="showCustomerResults && filteredUsers.length > 0">
                                        <div class="search-option" @click="selectCashSale()">
                                            <i class="fas fa-money-bill-wave me-2"></i>{{ __('cash_sale') }}
                                        </div>
                            ...
                            <div class="col-sm-4 col-12">
                                <button class="btn btn-primary w-100 py-2 h-100" @click="showRegisterModal">
                                    {{ __('register_user') }}
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="cart-items">
                                <div class="cart-item" v-for="(item, index) in cart" :key="index">
                                    ...
                                    <div class="item-quantity">
                                        <div class="figma-qty-selector">
                                            <button class="figma-qty-btn" @click="decreaseQuantity(index)">-</button>
                                            <input type="number" class="figma-qty-input" v-model="item.quantity" min="1" @change="updateCartItem(index)">
                                            <button class="figma-qty-btn" @click="increaseQuantity(index, item)">+</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-actions">
                                        <button class="btn btn-danger btn-sm border-0 bg-transparent p-0" @click="removeFromCart(index)">
                                            <base-icon name="Type=Default" hoverName="Type=Hover" width="44" height="44" />
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="figma-qty-selector">
                                        <button class="figma-qty-btn" @click="productQuantity > 1 ? productQuantity-- : 1">-</button>
                                        <input type="number" class="figma-qty-input" id="quantity" v-model="productQuantity" min="1">
                                        <button class="figma-qty-btn" @click="productQuantity++">+</button>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <button v-if="index > 0" type="button" class="btn btn-sm btn-outline-danger border-0 bg-transparent p-0"
...
.figma-qty-input:focus {
    outline: none !important;
    box-shadow: none !important;
}

.figma-qty-input::-webkit-outer-spin-button,
.figma-qty-input::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
}

.figma-qty-input[type=number] {
    -moz-appearance: textfield;
}

/* Dark Mode Overrides for Quantity Selector */
body.theme-dark .figma-qty-selector {
    background-color: #0F172A !important;
    border-color: #334155 !important;
}

body.theme-dark .figma-qty-btn {
    background-color: #1E293B !important;
    color: #F8FAFC !important;
}

body.theme-dark .figma-qty-btn:hover {
    background-color: #334155 !important;
    color: #FFFFFF !important;
}

body.theme-dark .figma-qty-input {
    background-color: #0F172A !important;
    color: #F8FAFC !important;
...
body.theme-dark .search-option {
    border-bottom-color: #334155 !important;
    color: #E2E8F0 !important;
}

body.theme-dark .search-option:hover {
    background-color: #334155 !important;
    color: #FFFFFF !important;
}
...
body.theme-dark .item-image {
    border-color: #334155 !important;
}

body.theme-dark .item-details h5,
body.theme-dark .item-details .price,
body.theme-dark .item-total {
    color: #F8FAFC !important;
}

body.theme-dark .variant-info {
...
body.theme-dark .pos-tab.active {
...
body.theme-dark .fullscreen-header {
...
body.theme-dark .search-option i {
    color: #94A3B8;
}
</style>
