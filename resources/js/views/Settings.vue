    ...
    <div>
        <div class="page-heading">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h3>{{ __('settings') }}</h3>
                <button v-if="isSellerOrDeliveryBoy" type="button" class="btn btn-danger" @click="deleteAccount"
                    :disabled="isLoading">
                    {{ __('delete_account') }}
                </button>
            </div>
                                ...
                                <div class="card">
                                                ...
                                                <div class="mt-5">
                                                    <div class="col-12 mt-4">
                                                        ...
                                                        <div v-for="(status, index) in statuses"
                                                            class="row d-flex justify-content-between align-items-center mb-2">
                                                            <div class="col-6 col-md-8">
                                                                <label> {{ getStatusDisplayName(status) }} </label>
                                                            </div>
                                                            <div
                                                                class="form-check form-switch col-3 col-md-2 d-flex justify-content-center m-0">
                                                            ...
                                                            <div
                                                                class="form-check form-switch col-3 col-md-2 d-flex justify-content-center m-0">
                                                                <input class='form-check-input' type='checkbox'
                                                                    :id="'checkbox_sms_' + status.id" :value="status.id"
                                                                    v-model="sms_statuses"
                                    ...
                                    <div class="card-footer d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary me-2" :disabled="isLoading">
                                            {{ __('save') }} <b-spinner v-if="isLoading" small
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label for='current_password'>{{ __('current_password')
                                                        }}</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type='password' id='password' v-model="settings.password"
                                                            class='form-control' :placeholder="__('new_password')"
                                                            required />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for='confirm_password'>{{ __('confirm_new_password')
                                                        }}</label>
