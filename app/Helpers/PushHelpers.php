...
class PushHelpers
{
    ...
    function __construct($title, $message, $image, $type, $type_id, $type_link, $order_id = null)
    {
        $this->title = $title;
    ...
    public function getPush()
    {
        ...
        if ($this->type === 'return_request' && !empty($this->order_id)) {
            $fcmMsg['order_id'] = $this->order_id;
        }
