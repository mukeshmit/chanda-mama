...
class StoreSettingsApiController extends Controller
{
    ...
    {
        $data = ['purchase_code'=>'MK#21EYHOIU','error'=>false];
    ...
    public function getPurchaseCodeUpdater()
    {
        ...
        $domain = env('APP_URL');
        $path = 'https://validator.koober.in/egrocer_validator?purchase_code=' . $code . '&domain_url=' . $domain;
        ...
        if ($code == 'direct_sale_from_koober') {
            $valid = true;
        }
