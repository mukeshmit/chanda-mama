...
class WithdrawalApiController extends Controller
{
    public function getRequest(Request $request){
        ...
        if($data){
            ...
            return CommonHelper::responseError('no_data_found');
        }
    }
    ...
    public function save(Request $request){
        ...
        if($user->balance == 0){
            return CommonHelper::responseError('your_wallet_balance_is_0');
        }else if($user->balance < $request->amount){
            return CommonHelper::responseError('your_wallet_balance_is' . $user->balance);
        }
        ...
        return CommonHelper::responseSuccess('withdrawal_request_saved_successfully');
    }
