...
Route::match(['get', 'post'], 'phonepe/callback', [\App\Http\Controllers\PhonepeController::class, 'phonepeWebhook'])->name('phonepe.callback');
...
Route::post('dpo/callback', [\App\Http\Controllers\DpoController::class, 'dpoCallback'])->name('dpo.callback');
Route::match(['get', 'post'], 'dpo/redirect', [\App\Http\Controllers\DpoController::class, 'dpoRedirect'])->name('dpo.redirect');
